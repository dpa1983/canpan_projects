...
! ***********************************************************************
      ...
      !  if (s% log_surface_luminosity > log_L_max) &
      !     log_L_max = s% log_surface_luminosity
      !  if (s% log_surface_luminosity > log_L_lo) return
      !  if (log_L_max >= log_L_hi) then
      !     write(*,'(a)') 'all values are within tolerance'
      !  else
      !     write(*,1) 'failed: log_L_max too small', log_L_max
      !  end if
