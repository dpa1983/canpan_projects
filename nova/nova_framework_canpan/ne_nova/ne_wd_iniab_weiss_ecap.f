      program wd2_iniab
      implicit none
      integer, parameter :: nsp = 286, m = 11, n = 87
      integer i, j, zone
      integer z(nsp), a(nsp)
      double precision x(nsp), xmix(nsp), xsum, xdeut
      character*4 symb1
      character*2 symb(nsp)
      double precision  lnd, lnT, lnR, L, dq, lnPgas, v,
     &   xh1, xhe3, xhe4, xli7, xbe7, xb8, xb11, 
     &   xc12, xc13, xc14, xn13, xn14, xn15,
     &   xo14, xo15, xo16, xo17, xo18, xo20, xf17, xf18, xf19,
     &   xf20, xf23,
     &   xne18, xne19, xne20, xne21, xne22, 
     &   xne23, xne24, xne25, xna20, xna21, xna22, 
     &   xna23, xna24, xna25, xna27,
     &   xmg21, xmg22, xmg23, xmg24, xmg25, xmg26, xmg27,
...
! input solar abundances
      open( 8, file = '/home/dpa/nugrid/' //
     &   'frames/mppnp/USEEPP/iniab1.4E-02GN93.ppn')
...
c     read( 9,120) zone, lnd, lnT, lnR, L, dq, v,
      read( 9,120) zone, lnd, lnT, lnR, L, dq, lnPgas,
     &   xh1, xhe3, xhe4, xli7, xbe7, xb8, xb11,
     &   xc12, xc13, xc14, xn13, xn14, xn15,
     &   xo14, xo15, xo16, xo17, xo18, xo20, xf17, xf18, xf19, 
     &   xf20, xf23,
     ...
     &   xcl35, xcl36, xcl37, xar33, xar34, xar35, xar36, xar37,
     &   xar38, xk36, xk37, xk38, xk39, xca39, xca40
  120 format(i5,93(4x,1pe23.16))
      q = q + dq
      if(xhe4 > 1d-10) go to 10
      mwd = mwd - q + dq
