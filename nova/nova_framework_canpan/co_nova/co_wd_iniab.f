      program wd2_iniab
      implicit none
      integer, parameter :: nsp = 286, m = 11, n = 33
      integer i, j, zone
      integer z(nsp), a(nsp)
     ...
     &   xc12, xc13, xn13, xn14, xn15,
     &   xo14, xo15, xo16, xo17, xo18, xf17, xf18, xf19,
     &   xne18, xne19, xne20, xne21, xne22, xna21, xna22, xna23,
     &   xmg22, xmg23, xmg24, xmg25, xmg26
...
c 120 format(i5,39(4x,1pe23.16))
  120 format(i5,38(4x,1pe23.16))
      q = q + dq
      if(xhe4 > 1d-15) go to 10
      mwd = mwd - q + dq
...
! 121 format(f3.1,33(2x,1pe23.16))
  ...
  250 format(//' The program has created the following files:' //
     &   ' co_wd_iniab.ppn'/' accreted_ab.out'/
     &   ' relaxed_composition'//)
